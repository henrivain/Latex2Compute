...
namespace MekLatexTranslationLibrary.Helpers
{
    internal static class TranslationTag
    {
        ...
        internal static string ToNspireOperator(string inp)
        {
            ...
            //log
            inp = inp.Replace("#111#", "log");
            inp = inp.Replace("#112#", "ln");
            //system
            inp = inp.Replace("#121#", "system");
            inp = inp.Replace("#122#", ",");
            //trigonometry
            inp = inp.Replace("#131#", "arcsin");
            inp = inp.Replace("#132#", "sin");
            inp = inp.Replace("#133#", "arccos");
            inp = inp.Replace("#134#", "cos");
            inp = inp.Replace("#135#", "arctan");
            inp = inp.Replace("#136#", "tan");
            //sqrt 
            inp = inp.Replace("#142#", "sqrt");
            inp = inp.Replace("#141#", "root");
            //lim
            inp = inp.Replace("#151#", "lim");
            // pi
            inp = inp.Replace("#161#", "pi");
        ...
        internal static string TryAddInsides(string input, string tag, string charsBeforeWildCard)
        {
            ...
            while (index >= 0)
            {
                bool isValidTag = ArgsMatch(input[index..], tag);
